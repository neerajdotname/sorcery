      ...
      module ResetPassword       
        ...
        module InstanceMethods
          ...
          def deliver_reset_password_instructions!
            ...
            return false if config.reset_password_time_between_emails && self.send(config.reset_password_email_sent_at_attribute_name) && self.send(config.reset_password_email_sent_at_attribute_name) > config.reset_password_time_between_emails.ago.utc.to_datetime
